...
export default function Sidebar({ navItems, locale }: SidebarProps) {
  ...
  return (
    <aside className="w-full md:w-56 md:sticky md:top-0 md:h-screen bg-white dark:bg-gray-800 shadow-md overflow-y-auto">
      <div className="p-3">
        {navItems.map((item, index) => {
          ...
          return (
            <a 
              key={index} 
              href={href}
              className={`flex items-start p-2 mb-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors ${
